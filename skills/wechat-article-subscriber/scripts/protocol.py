...
NEXT_ACTIONS = {
    ...
    "LARK_BOT_CREDENTIALS": "configure_bot_credentials_and_scopes_without_user_auth",
    ...
    "LARK_CONFIG": "configure_isolated_lark_profile",
...
def classify_exception(exc: Exception) -> tuple[str, bool]:
    ...
    if name == "LarkCLIError":
        ...
        aliases = {
            ...
            "BOT_CREDENTIALS": "LARK_BOT_CREDENTIALS",
